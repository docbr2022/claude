...
import { Users, Image, LayoutTemplate, MessageCircle, FileText, Megaphone } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-ink-50">
      <div className="hidden lg:flex flex-col justify-between bg-ink-950 text-white p-12 relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-2 text-lg font-display font-semibold">
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-2 text-lg font-display font-semibold mb-8 text-ink-900">
            <img src="/logo-icon.png" alt="" className="h-8 w-8" />
            Projeto Zero
          </div>
